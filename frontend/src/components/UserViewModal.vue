    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="card mb-3">
            <div class="card-body">
              <h4 class="h6 text-primary">Personal Information</h4>
              <div class="row g-3">
          ...
          <div class="card mb-3">
            <div class="card-body">
              <h4 class="h6 text-primary">Contact Details</h4>
              <div class="row g-3">
          ...
          <div class="card mb-3">
            <div class="card-body">
              <h4 class="h6 text-primary">Medical Details</h4>
              <div class="row g-3">
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="h6 text-primary">Experience &amp; Training</h4>
              <div class="row g-3">
